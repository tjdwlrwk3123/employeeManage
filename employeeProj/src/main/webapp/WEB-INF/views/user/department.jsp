...
<div id="manageList">
	<ul>
		...
		<li><button class="btn btn-info btn-block" onclick="location.href='${pageContext.request.contextPath}/department'">부서관리</button></li>
...
<div id="deptList">
	...
	<table id="deptTable" class="table">
		...
		<tr>
			...
			<td>
				<a href="${pageContext.request.contextPath}/deptDelete?deptNum=${dept.deptNum}">삭제</a>
